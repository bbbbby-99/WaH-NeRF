...
def get_config():
    ...
    config.add_argument("--log_dir", type=str, default="log_lego")
    ...
    config.add_argument("--white_bkgd", action="store_false", default= True)  # should be False if using llff
    ...
    config.add_argument("--max_steps", type=int, default=30_001)
    config.add_argument("--batch_size", type=int, default=16)
    config.add_argument("--do_eval", action="store_false", default=False)
    config.add_argument("--continue_training", action="store_true")
    config.add_argument("--save_every", type=int, default=5000)
    ...
    config.add_argument("--model_weight_path", default="log_lego/30000model.pt")
    ...
    # base_data_path = "/data2/byq/nerf_llff_data/"
